...
namespace CF_PyromaniacIsFun
{
    public class Patcher : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            {
                var rect = list.Label("Pyromania need cost per fire arrow", tooltip: null);
            ...
            {
                var rect = list.Label("Pyromania need cost per melee ignite", tooltip: null);
            ...
            {
                var rect = list.Label("Pyromaniac melee ignite chance", tooltip: "How often would a pyromaniac set his target on fire in melee attack");
                Widgets.TextFieldNumeric(rect.RightPartPixels(50), ref Settings.MeleeIgniteChance, ref meleeIgniteChanceBuffer, 0, 0.99f);
            }
            {
                var rect = list.Label("Pyromania need gain per wild fire per pay", tooltip: null);
            ...
            {
                var rect = list.Label("Pyromania need gain per burning pawn per pay", tooltip: null);
            ...
            {
                var rect = list.Label("Pyromania need gain self on fire per pay", tooltip: null);
            ...
            {
                var rect = list.Label("Pyromania need gain from meditation (flame) multiplier", tooltip: "Gaining speed is this multiplier x meditation focus strength from the object");
            ...
            list.CheckboxLabeled("Pyromaniacs feel happy only when carrying truly incendiary weapon", ref Settings.HappyWhenCarryingTrulyIncendiaryWeapon, "Mood bonus for ranged weapons that deal flame damage, e.g. incendiary launcher, but not e.g. smoke launcher");

            list.CheckboxLabeled("Pyromaniacs aim incendiary weapon well", ref Settings.RemoveForcedMissRadius, "Remove forced miss radius for ranged weapons that deal flame damage, e.g. incendiary launcher, but not e.g. smoke launcher");
            list.End();
    ...
    public static class Patch_MentalStateWorker_StateCanOccur
    {
        public static void Postfix(MentalStateWorker __instance, Pawn pawn, ref bool __result)
        {
            ...
            {
                __result = false;
                PyromaniacUtility.ThrowText(pawn, () => "Prevented FireStartingSpree", 4);
            }
        }
    }
